...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentPlaceHolderMainItem" runat="server">
    <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <br />
                    <h2><asp:Label ID="centerNameLabel" runat="server" Text="Label"></asp:Label></h2>
    ...
    <div style="width: 716px">
        ...
        <asp:GridView ID="treatmentGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="Both" Width="715px">
