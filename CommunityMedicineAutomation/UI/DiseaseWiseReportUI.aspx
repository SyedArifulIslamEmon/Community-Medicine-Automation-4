...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentPlaceHolderMainItem" runat="server">
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Text="Select Disease" Font-Size="20" Font-Bold="true"></asp:Label>
        ...
        <input type="date" name="dateFrom" id="dateFrom" style="font-size:15px; height: 22px;"/>
        ...
        <asp:Button ID="showButton" runat="server" Text="Show Report" OnClick="showButton_Click" Font-Size="20" Font-Bold="true" ForeColor="Green" /><br /><br />
        <asp:Label ID="megLabel" runat="server" Text=""></asp:Label><br /><br />
        <asp:GridView ID="reportGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="552px">
