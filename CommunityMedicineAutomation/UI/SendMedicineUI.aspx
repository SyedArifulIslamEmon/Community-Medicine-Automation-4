...
<asp:Content ID="Content8" ContentPlaceHolderID="ContentPlaceHolderMainItem" runat="server">
    ...
    <div>
        ...
        <asp:GridView ID="sendMedicineGridView" runat="server" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="OnPaging" CellPadding="4" ForeColor="#333333" GridLines="None" Width="283px">
